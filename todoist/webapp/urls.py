...
from webapp.views import todo_list_view, todo_create_view, todo_view, delete_todo_view, todo_update_view
...
urlpatterns = [
    ...
    path('todos/update/<int:pk>/', todo_update_view, name='update_todo'),
]
